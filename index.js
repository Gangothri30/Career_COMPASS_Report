...
function draw(){
   ...
   /* if(response1<5 && response2<5){
    ...
    if(response1==9 && response2==9 && response3==9)
    {
...
form.addEventListener('submit',e => {
    ...
    if(response1<=4)
    {
        driveId.style.backgroundColor = "#ffe05d";
        ...
        driveId.style.backgroundColor = "#b8de6f";
        ...
        driveId.style.backgroundColor = "green";
    ...
    if(response2<=4)
    {
        skillId.style.backgroundColor = "#ffe05d";
        ...
        skillId.style.backgroundColor = "#b8de6f";
        ...
        skillId.style.backgroundColor = "green";
    ...
    if(response3<=4)
    {
        growthId.style.backgroundColor = "#ffe05d";
        ...
        growthId.style.backgroundColor = "#b8de6f";
        ...
        growthId.style.backgroundColor = "green";
